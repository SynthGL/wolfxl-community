...
- `wolfxl peek <file>` - styled preview or text/csv/json/markdown export
...
The `text`, `csv`, `json`, and `markdown` exporters are tuned for piping into
LLM / agent contexts and Unix tooling. Human-facing `box`, `text`, `csv`, and
