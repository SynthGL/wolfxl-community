...
//!
//! - DEFLATE level 1 for entries ≥ 128 bytes, STORE
...
const FAST_SAVE_DEFLATE_LEVEL: i64 = 1;
...
///
/// Entries are written in the order provided. Each entry uses fast DEFLATE
/// unless its body is under [`DEFLATE_MIN_BYTES`] bytes, in
