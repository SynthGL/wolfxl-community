...
fn builtin_num_fmt_id(code: &str) -> Option<u32> {
    match code {
        ...
        "#,##0_);[Red](#,##0)" => Some(38),
        "#,##0.00_);(#,##0.00)" => Some(39),
        "#,##0.00_);[Red](#,##0.00)" => Some(40),
        r#"_(* #,##0_);_(* \(#,##0\);_(* "-"_);_(@_)"# => Some(41),
        r#"_("$"* #,##0_);_("$"* \(#,##0\);_("$"* "-"_);_(@_)"# => Some(42),
        r#"_(* #,##0.00_);_(* \(#,##0.00\);_(* "-"??_);_(@_)"# => Some(43),
        r#"_("$"* #,##0.00_)_("$"* \(#,##0.00\)_("$"* "-"??_)_(@_)"# => Some(44),
        "mm:ss" => Some(45),
        "[h]:mm:ss" => Some(46),
        "mmss.0" => Some(47),
        "##0.0E+0" => Some(48),
