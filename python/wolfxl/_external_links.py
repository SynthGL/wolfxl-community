...
class ExternalLink:
    ...
    externalBook: Any = None  # noqa: N815
    ddeLink: Any = None  # noqa: N815
    oleLink: Any = None  # noqa: N815
    ...
    @property
    def path(self) -> str:
        return f"/xl/externalLinks/externalLink{getattr(self, '_id', None)}.xml"
...
_install_openpyxl_iter(ExternalFileLink, ExternalLink)
